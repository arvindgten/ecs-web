(function() {
	...
	var hostName = "https://marathi-delta.pratilipi.com";
	var apiPrefix = "https://marathi-delta.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DELTA_MARATHI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DELTA_MARATHI.json" ) === -1
