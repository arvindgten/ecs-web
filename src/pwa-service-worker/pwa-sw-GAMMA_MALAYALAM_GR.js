(function() {
	...
	var localFilesToCache = [
		'.',
		'pwa-stylesheets/css/style.css?120520181904',
		'pwa-images/404.svg',
	...
	var STATIC_VERSION = "120520181904";
	...
	/* Cache Keys */
	var PWA_INDEX_HTML = "app-shell-120520181904.html";
	...
	self.addEventListener( 'push', function(event) {
		...
		if( pratilipi ) {
			var title = pratilipi.displayTitle,
				options = {
					badge: 'https://storage.googleapis.com/public.pratilipi.com/pratilipi-logo/png/Logo-2C-RGB-80px.png',
