(function() {
	...
	var hostName = "https://telugu-delta.pratilipi.com";
	var apiPrefix = "https://telugu-delta.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DELTA_TELUGU.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DELTA_TELUGU.json" ) === -1
