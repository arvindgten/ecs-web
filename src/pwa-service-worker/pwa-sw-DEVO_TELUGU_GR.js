(function() {
	...
	var localFilesToCache = [
		'.',
		'pwa-stylesheets/css/style.css?120520181809',
		'pwa-images/404.svg',
	...
	var STATIC_VERSION = "120520181809";
	...
	/* Cache Keys */
	var PWA_INDEX_HTML = "app-shell-120520181809.html";
	...
	self.addEventListener( 'push', function(event) {
		...
		if( pratilipi ) {
			var title = pratilipi.displayTitle,
				options = {
					// badge: pratilipi.coverImageUrl,
					body: pratilipi.summary,
					// icon: pratilipi.coverImageUrl, 
