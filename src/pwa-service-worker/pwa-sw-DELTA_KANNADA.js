(function() {
	...
	var hostName = "https://kannada-delta.pratilipi.com";
	var apiPrefix = "https://kannada-delta.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DELTA_KANNADA.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DELTA_KANNADA.json" ) === -1
