(function() {
	...
	var hostName = "https://tamil-delta.pratilipi.com";
	var apiPrefix = "https://tamil-delta.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DELTA_TAMIL.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DELTA_TAMIL.json" ) === -1
