(function() {
	...
	var localFilesToCache = [
		'.',
		'pwa-stylesheets/css/style.css?070620181542',
		'pwa-images/404.svg',
	...
	var STATIC_VERSION = "070620181542";
	...
	var hostName = "https://gujarati-delta.pratilipi.com";
	var apiPrefix = "https://gujarati-delta.pratilipi.com";

	/* Cache Keys */
	var PWA_INDEX_HTML = "app-shell-070620181542.html";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DELTA_GUJARATI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DELTA_GUJARATI.json" ) === -1
