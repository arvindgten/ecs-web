(function() {
	...
	var hostName = "https://www-delta.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DELTA_ALL_LANGUAGE.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DELTA_ALL_LANGUAGE.json" ) === -1
