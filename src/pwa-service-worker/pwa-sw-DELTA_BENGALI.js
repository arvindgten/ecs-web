(function() {
	...
	var hostName = "https://bengali-delta.pratilipi.com";
	var apiPrefix = "https://bengali-delta.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DELTA_BENGALI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DELTA_BENGALI.json" ) === -1
